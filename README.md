[![Build status](https://ci.appveyor.com/api/projects/status/gh2jr61iym0ns4c0/branch/master?svg=true)](https://ci.appveyor.com/project/maria-namira/router-crud-front/branch/master)

# CRUD 

### Deployment:  <a href="https://github.com/maria-namira/router-crud-front.git/">Github Pages</a>
